...
const LandingPage = () => {
  ...
  return (
    <section
      id="HomeSection"
      className="max-w-screen min-w-screen w-screen pt-[10vw] md:pt-[3vh] h-fit mb-[7vh] md:mb-[15vh] lg:mb-[10vh]"
    >
      {/* PELUMI Section */}
      <motion.div
      ...
      {/* Desktop PELUMI */}
      <motion.div
        className="hidden lg:block text-[8vw] w-screen bg-accent-2 text-primary font-montserrat overflow-hidden"
        initial={{ x: "-100%" }}
        animate={{ x: 0 }}
        transition={{ ease: "linear", duration: 0.9 }}
      >
      ...
      {/* Additional Content */}
      <motion.div
        className="text-center m-[1.6vw] px-[2%] text-[15px] md:text-[2.0vh] lg:text-[27px] font-inter lg:pt-3 pt-5"
      ...
      >
        <span>
          I&apos;m a{" "}
          <span className="font-medium text-accent-1">Full-stack developer</span>{" "}
          passionate about bringing ideas to life,
        </span>
        <span className="md:block">
          {" "}
          and turning problems into long-lasting solutions
        </span>
      </motion.div>
