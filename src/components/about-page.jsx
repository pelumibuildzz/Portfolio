...
const AboutPage = () => {
  ...
  return (
    <section id='AboutSection' className='max-w-screen w-screen mt-[4vw] lg:mt-[10vw] md:mt-[1vh] h-fit font-mono grid grid-cols-12 gap-[25px] px-[8vw] overflow-hidden'>
      ...
      <div className='col-span-12 lg:col-span-8 text-[18px] md:text-[24px] lg:text-[30px]'>
        ...
        >
          I'm working on exciting projects that I can't wait to share. But I'm always open to new challenges, collaborations, and opportunities to create something amazing.
        </motion.div>
      </div>
      <div className='col-span-12 lg:col-span-4 text-[18px] md:text-[24px] font-light lg:text-[30px] '>
        ...
        >
          ...
          <div className="font-light text-[15px] md:text-[20px] lg:text-[25px]">React, Next.js, Vitetest, HTML5, CSS/SCSS/SASS, TailwindCSS, Framer, Redux Toolkit, Redux.</div>
        </motion.div>
        ...
        >
          ...
          <div className="font-light text-[15px] md:text-[20px] lg:text-[25px]">Node.js, Express.js, Python, FastAPi, MongoDB, Mongoose, Postgres, Prisma.</div>
        </motion.div>
        <motion.div className='mt-5'
          initial={{ opacity: 0, x: 50 }}
          animate={ isInView ? { opacity: 1, x: 0} : {}}
        ...
        >
          ...
          <div className="font-light text-[15px] md:text-[20px] lg:text-[25px]">Programming(Obviously), Sales and Marketing, Ancient Philosophy, Gaming, New Tech, Science and Engineering.</div>
        </motion.div>
      </div>
    </section>
  )
